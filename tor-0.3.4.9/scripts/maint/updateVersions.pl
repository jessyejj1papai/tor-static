...
$CONFIGURE_IN = '/tmp/tor-build/tor-0.3.4.9/configure.ac';
$ORCONFIG_H = '/tmp/tor-build/tor-0.3.4.9/src/win32/orconfig.h';
$TOR_NSI = '/tmp/tor-build/tor-0.3.4.9/contrib/win32build/tor-mingw.nsi.in';
