...
#define BUILDDIR "/tmp/tor-build/tor-0.3.4.9"

/* tor's configuration directory */
#define CONFDIR "/tmp/tor-build/tor-0.3.4.9/install/etc/tor"
...
#define PACKAGE_STRING "tor 0.3.4.9"
...
#define PACKAGE_VERSION "0.3.4.9"
...
#define SRCDIR "/tmp/tor-build/tor-0.3.4.9"
